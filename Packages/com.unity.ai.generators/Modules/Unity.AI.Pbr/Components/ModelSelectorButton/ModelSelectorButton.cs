...
namespace Unity.AI.Pbr.Components
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.ai.generators/modules/Unity.AI.Pbr/Components/ModelSelectorButton/ModelSelectorButton.uxml";
        ...
        {
            using var editorFocus = new EditorAsyncKeepAliveScope("Discovering AI Models for material.");
