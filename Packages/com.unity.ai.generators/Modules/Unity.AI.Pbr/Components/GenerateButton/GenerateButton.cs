...
namespace Unity.AI.Pbr.Components
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.ai.generators/modules/Unity.AI.Pbr/Components/GenerateButton/GenerateButton.uxml";
        ...
        void OnGenerate() =>
            this.GetStoreApi().Dispatch(GenerationResultsActions.generateMaterialsMain, this.GetAsset());
    }
}
